...
class MongoEventStoreTest {
    ...
    void shouldSaveEvent_WhenProvideCorrectData() {
        // given
        FakeEvent event = new FakeEvent(EVENT1_ID, AGGREGATE_ID, "desc", LocalDateTime.now());
    ...
    void shouldSaveAndLoadEvent_WhenProvideCorrectData() {
        // given
        FakeEvent event1 = new FakeEvent(EVENT1_ID, AGGREGATE_ID, "desc1", LocalDateTime.now());
        FakeEvent event2 = new FakeEvent(EVENT2_ID, AGGREGATE_ID, "desc2", LocalDateTime.now());
        FakeEvent event3 = new FakeEvent(EVENT3_ID, AGGREGATE_ID, "desc3", LocalDateTime.now());
    ...
    void shouldThrowException_WhenTryingToSave2EventsWithSameVersion() {
        // given
        FakeEvent event1 = new FakeEvent(EVENT1_ID, AGGREGATE_ID, "desc", LocalDateTime.now());
        FakeEvent event2 = new FakeEvent(EVENT2_ID, AGGREGATE_ID, "desc", LocalDateTime.now());
        eventStore.save(event1, 1);
